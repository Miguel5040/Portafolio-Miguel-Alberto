...
import { fadeLeftAnimation, fadeRightAnimation } from "../sub-components/Animations"
...
const StarWarsBlog = () => (
    ...
    <article className="flex flex-col md:flex-row lg:justify-center justify-between items-center gap-10">
        ...
        className="w-full md:w-1/2 flex items-center md:max-w-[500px] shadow-[0_1px_60px_-20px_rgba(0,0,0,0.3)] shadow-[#aaa]">
            <img className="w-[100%] aspect-video" src="./images/starwarsBlog.jpg" alt="imagen de proyecto" />
        </motion.div>
        ...
        className="flex flex-col md:items-start items-center gap-4 w-full md:w-1/2">
            ...
            <div className="flex flex-col gap-4 md:items-start items-center">
                <ul className="flex gap-2 items-center flex-wrap">
                    ...
                    <li className="text-md font-medium me-2 px-2.5 py-0.5 rounded bg-orange-100 text-orange-800 flex items-center gap-2">
                        <span className="flex items-center"><img className="w-[18px]" src="./slider-icons/html5.svg" alt="Logo react" /></span>
                        HTML
                    </li>
                    <li className="text-md font-medium me-2 px-2.5 py-0.5 rounded bg-indigo-100 text-indigo8300 flex items-center gap-2">
