...
const IMAGEN_PRUEBA = "https://t4.ftcdn.net/jpg/00/64/67/63/360_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg"
                ...
                <motion.div
                    ...
                    <motion.div
                        ...
                        <a href={`mailto:${MAIL}`} className="gap-2 w-fit inline-flex items-center p-2 text-sm font-medium rounded-lg bg-white text-gray-700 hover:text-[#3aa9ab] hover:bg-gray-100 border border-gray-300" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-mail-filled" width="30" height="30" viewBox="0 0 24 24" strokeWidth="1.5" stroke="black" fill="black" strokeLinecap="round" strokeLinejoin="black"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M22 7.535v9.465a3 3 0 0 1 -2.824 2.995l-.176 .005h-14a3 3 0 0 1 -2.995 -2.824l-.005 -.176v-9.465l9.445 6.297l.116 .066a1 1 0 0 0 .878 0l.116 -.066l9.445 -6.297z" strokeWidth="0" fill="currentColor" /><path d="M19 4c1.08 0 2.027 .57 2.555 1.427l-9.555 6.37l-9.555 -6.37a2.999 2.999 0 0 1 2.354 -1.42l.201 -.007h14z" strokeWidth="0" fill="currentColor" /></svg>
                        </a>
                    </motion.div>
                </motion.div>
            </Section>
