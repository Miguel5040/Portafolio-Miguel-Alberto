...
const AboutMe = () => {
    ...
    return (
        <section className="flex justify-center items-start py-20 md:py-32 md:h-[650px] bg-[#f5f5f5]">
            <div className="container flex flex-col gap-6 justify-center items-center w-[90%] md:max-w-[950px]">
