        ...
        <article>
            <ol className=" border-s-2 border-[#bcbcbc] h-full">
                <li className="ms-4 h-full flex flex-col justify-center xl:justify-between items-start">
                    ...
                    <a href="https://certificate.4geeks.com/31d61db754308ddec0deb4eb329eab8f07dcd948" className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg bg-white text-gray-900 hover:text-[#3aa9ab] hover:bg-gray-100 border border-gray-300" target="_blank">Ver Certificado <svg className="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
